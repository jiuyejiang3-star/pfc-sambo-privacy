...
PFC参謀（以下「本アプリ」）は、ユーザーのプライバシーを最大限尊重します。本ポリシーは、本アプリが扱うデータの種類、利用目的、第三者への提供の有無について説明します。
...
PFC Sambo (the "App") respects your privacy. This policy explains what data the App handles, how it is used, and whether it is shared with third parties.
